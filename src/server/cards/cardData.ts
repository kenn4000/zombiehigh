...
export const ALL_CARD_DEFINITIONS: ICard[] = [
  ...
  card(CardName.ATTENDANCE_SHEET, 5, I, [and(inRoom('principals-office'), or(niceP('==', 0), cp('==', 0)))], { gain: { sp: 1, gp: 1 } }),
  ...
  card(CardName.BANNED_BOOK, 4, I, [inRoom('library')], { gain: { cp: 4 } }),
  card(CardName.BATHROOM_TRAP, 2, I, [trapInRoom('restrooms')], { gain: { sp: 1 } }),
  ...
  card(CardName.CHICKEN_DINNER, 5, I, [special('playerHighestSP')], { gain: { sp: 2, np: 1 } }),
  ...
  card(CardName.CLASSIC_FICTION, 5, I, [inRoom('library')], { gain: { np: 4 } }),
  ...
  card(CardName.DETENTION_SLIP, 3, I, [inRoom('principals-office')], { gain: { cp: 4 } }),
  ...
  card(CardName.DISGUSTING_MESS, 4, I, [and(cp('>=', 5), inRoom('restrooms'))], { gain: { cp: 4 } }),
  ...
  card(CardName.ATHLETIC_FOOTWEAR, 8, P, [inRoom('gymnasium')], { gain: { sp: 1 }, passive: { movementCostInRoom: { room: 'gymnasium', reduction: 1 } } }),
  ...
  card(CardName.PERMISSION_SLIP, 6, I, [inRoom('principals-office')], { gain: { np: 4 } }),
  ...
  card(CardName.SPOILED_MILK, 4, I, [and(cp('>=', 6), inRoom('cafeteria'))], { gain: { cp: 3 } }),
  ...
  card(CardName.TRANSFUSION, 2, I, [special('adjacentPlayerAt1HP')], { gain: { np: 3 }, giveHPtoAdjacent: { hpAmount: 1 } }),
  ...
  card(CardName.WATER_COOLER, 4, I, [inRoom('lobby')], { gain: { hp: 1, sp: 1 } }),
  card(CardName.WELL_WORN_BOOK, 6, I, [inRoom('library')], { gain: { gold: 12 }, drawCards: 2 }),

  // ── Z ──────────────────────────────────────────────────────────────────────
  card(CardName.ZOMBIE_FLUSH, 9, I, [], { gain: { sp: 1 }, killZombie: { count: 1 } }),

  // ── Hero passives ──────────────────────────────────────────────────────────
  card(CardName.HERO_SCHADENFREUDE_PASSIVE, 0, P, [], { passive: {} }),
  card(CardName.HERO_BARRY_CADE_PASSIVE, 0, P, [], { passive: { allBarricadeEffectiveness: 1 } }),
  card(CardName.HERO_VON_TRAP_PASSIVE, 0, P, [], { passive: { trapLimitBonus: 1 } }),
  ...
  card(CardName.HERO_BUNGLER_PASSIVE, 0, P, [], { passive: {} }),
  card(CardName.HERO_ARCHY_TECT_PASSIVE, 0, P, [], { passive: {} }),
